...
public class FindInFuelRangeTest {
    private final ByteArrayOutputStream outContent = new ByteArrayOutputStream();
    private final PrintStream originalOut = System.out;
    private TaxiPark park = new TaxiPark();
    ...
    private boolean checkSearchCommand() {
        ...
        park.findAllCarsInFuelSpendRange(2.5, 3.3);
        return outContent.toString().equals(expected);
    }

    private void assertEquals(String hello, String toString) {
    }
